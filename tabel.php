...
<div class="container mt-3">
  ...
  <p>Data berasal dari mysql</p> 
  <a button type="button" class="btn btn-primary" href="form.php">Tambah</button></a>           
  <table class="table table-striped">
    ...
    ?>
        <tr>
            ...
            <td>
            <button type="button" class="btn btn-sn btn-info">Edit</button>
            <button type="button" class="btn btn-sn btn-danger">Delete</button>
            </td>
        </tr>
    <?php   
    }
